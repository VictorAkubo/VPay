    ...
    return (
        <section className="recent-transactions">
            ...
            <Tabs defaultValue={appwriteItemId} className="w-full">
                ...
                {accounts.map((account: Account) => (
                    <TabsContent key={account.id} className='space-y-4' value={account.appwriteItemId}>
                        <BankInfo key={account.id} account={account} appwriteItemId={appwriteItemId} type='full' />
