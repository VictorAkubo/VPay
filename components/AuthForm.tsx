        ...
        <section className="auth-form">
            <header className='flex flex-col gap md:gap-8'>
                <Link href="/" className=' flex cursor-pointer items-center gap-1 '>
                    ...
                    />
                    <h1 className='text-26 font-ibm-plex-serif font-bold text-black-1'>VPay</h1>
                </Link>
                            ...
                            {type === "sign-up" && (
                                <>
                                    ...
                                    <div className="flex gap-4">
                                        ...
                                        <CustomInput control={form.control} name="postalCode" label="Postal Code" placeholder="12203" />
                                    </div>
                                    <div className="flex gap-4">
                                        <CustomInput control={form.control} name="dateOfBirth" label="Date Of Birth" placeholder="YYYY-MM-DD" />
                                        <CustomInput control={form.control} name="ssn" label="SSN" placeholder="example of 1234" />
                                    </div>
                                </>
                            )}
